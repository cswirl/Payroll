...
Public Class ConsolidatedPayrollRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentation.ConsolidatedPayrollRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsolidatedPayrollRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsolidatedPayrollRegister = New ConsolidatedPayrollRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
