...
Public Class PayrollSheet_weekly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Presentation.PayrollSheet_weekly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayrollSheet_weekly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayrollSheet_weekly = New PayrollSheet_weekly()
        rpt.Site = Me.Site
        Return rpt
    End Function
