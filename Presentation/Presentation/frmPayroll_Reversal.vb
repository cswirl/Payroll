...
Public Class frmPayroll_Reversal
    ...
    Private Sub findPayroll(ByVal payrollNumber As UInteger)
        Try
    ...
    Private Sub fillTextBoxes()
        With payroll
            ...
            txtGross.Text = .grossPay().ToString("0.00")
            txtGross_2.Text = .grossPay().ToString("0.00")
    ...
    Private Sub setAllowance(ByVal payrollNum As UInteger)
        Try
            ...
            Dim allow_total As Double = nonTax_allowance + taxable_allowance
            txtAllowance_total.Text = allow_total.ToString("0.00")
    ...
    Private Sub setGross()
        ...
        Dim gross As Double = income + CDbl(DBNullToNumeric(txtAllowance_total.Text))
    ...
    Private Sub setNetIncome()
        Dim gross As Double = CDbl(DBNullToNumeric(txtGross.Text))
        Dim deductions As Double = CDbl(DBNullToNumeric(txtDeduction_total.Text))
        Dim allow_total As Double = CDbl(DBNullToNumeric(txtAllowance_total.Text))
